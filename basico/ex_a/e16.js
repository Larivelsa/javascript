/**Percorra o array 'chuvaDeMeteoros' e execute a função 'imprimirChuva' 
 * que imprime o nome da chuva e o hemisfério que ela pode ser observada. */
...
const chuvaDeMeteoros = [
 ...
 function imprimirChuva = chuvaDeMeteoros.filter ((chuva) {
 const hemisferio = ( chuva.declinacao >= 0 ) ______________ 'Norte' ______________ 'Sul';
